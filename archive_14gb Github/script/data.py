...
from torchvision.transforms.transforms import CenterCrop, ColorJitter, RandomHorizontalFlip
from torch.utils.data import Dataset
# from main import augment
...
# if __name__ == '__main__':
    ...
    # visualiz()
    # main()
    process_image_file_medusa('/media/trucloan/Data/Research/BT_Phu/covid-chestxray-dataset-master/archive_14gb/dataset/train/0ac7580d.jpg', 224)
...
def random_ratio_resize(img, prob=0.3, delta=0.1):
    ...
    return img
_augmentation_transform = transforms.Compose([
    transforms.RandomRotation(10),
    transforms.RandomAffine(10,translate=(0.1,0.1), fill=0),
...
def apply_augmentation(img):
    ...
    img = _augmentation_transform(img)
    return img
...
class BalanceCovidDataset(Dataset):
